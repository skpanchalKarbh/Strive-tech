...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  const sizes = sizeFromProps
    ...
    : Object.entries(breakpoints)
        .map(([, value]) => `(max-width: ${value}px) ${value * 2}px`)
        .join(', ')

  let dataValue1 = undefined
  let dataValue2 = undefined
  if ( imgClassName?.includes('mil-scale-img-top') ) {
    dataValue1 = '1';
    dataValue2 = '1.3';
  }
  else if ( imgClassName?.includes('mil-scale-img-alt') ) {
    dataValue1 = '1';
    dataValue2 = '1.15';
  }
  else if ( imgClassName?.includes('mil-scale-img') ) {
    dataValue1 = '1.1';
    dataValue2 = '1';

    if ( imgClassName?.includes('mil-scale-img-1-1_1') ) {
      dataValue1 = '1';
      dataValue2 = '1.1';
    }
  }
